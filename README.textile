...
If you have a User model and authentication with Devise, you can add pages to display a list of users or each user's profile, restricted to logged in users.
